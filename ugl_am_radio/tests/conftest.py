...
class MockSCPIServer:
    ...
    def __init__(self, host: str = "127.0.0.1", port: int = 0):
        ...
        self.responses = {"*IDN?": "MockRedPitaya,AMRadio,v1.0,TEST", "SYST:STAT?": "0x00000006"}
        self._thread = None
...
def default_channel_state() -> dict:
    ...
    return {"enabled": False, "frequency_khz": 700, "frequency_hz": 700000}
...
def default_system_state() -> dict:
    ...
    return {
        ...
        "audio_source": "BRAM",
        "selected_message": 1,
        "ch1": {"enabled": False, "frequency_khz": 700},
        "ch2": {"enabled": False, "frequency_khz": 900},
    }
...
def test_config() -> dict:
    ...
    return {
        "connection": {"default_ip": "127.0.0.1", "default_port": 5000, "timeout_seconds": 1},
        "channels": {
            "ch1": {"default_freq_khz": 700, "min_freq_khz": 530, "max_freq_khz": 1700},
            "ch2": {"default_freq_khz": 900, "min_freq_khz": 530, "max_freq_khz": 1700},
        },
    }
